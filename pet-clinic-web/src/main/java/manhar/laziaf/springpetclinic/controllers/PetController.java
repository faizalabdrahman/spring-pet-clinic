...
public class PetController
{
    ...
    public String initUpdatePetFrom(@PathVariable("petId") Long petId, Model model)
    {
    ...
    public String processUpdatePetFrom(@Valid Pet pet, BindingResult result, Owner owner, Model model)
    {
        if(result.hasErrors())
        {
            pet.setOwner(owner);
